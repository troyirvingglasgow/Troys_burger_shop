...
- This months prize is a $50 Giftcard to Troy's Burgers!
- 1 entry per order
...
#makes it so that you cant leave a blank space resulting in always getting a answer.
...
print("A {} burger with {} as the sides with a total cost of ${}" .format(BURGERS_SOLD_LIST, SIDE_PICKED,sum(PRICES_LIST) ,) .replace('[', '').replace(']', '').replace('\'', ''),)
